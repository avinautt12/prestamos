...
export default function AdminLayout({ children, title = 'Prestamo Fácil' }) {
    ...
    useEffect(() => {
        ...
        const rol = auth?.user?.rol_codigo;
        ...
        if (rolCodigo === 'GERENTE' || rolCodigo === 'CAJERA') {
    ...
    }, [auth?.user?.id, rolCodigo, auth?.sucursal_id]);

    const navigation = rolCodigo === 'ADMIN' ? [
        ...
        { name: 'Calendario Global', href: route('admin.calendario'), icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
        ...
        { name: 'Solicitudes de Contraseña', href: route('admin.solicitudes_password'), icon: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4v-3.252l7.546-7.546A6 6 0 1115 9z' },
        ...
        { name: 'Auditorías', href: route('admin.auditorias'), icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ...
        { name: 'Fidelización', href: route('admin.fidelizacion.index'), icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
        { name: 'Rentabilidad', href: route('admin.rentabilidad'), icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }
    ] : rolCodigo === 'GERENTE' ? [
        ...
        { name: 'Solicitudes de Contraseña', href: route('gerente.solicitudes_password'), icon: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4v-3.252l7.546-7.546A6 6 0 1115 9z' },
        ...
        { name: 'Gestión Crédito', href: route('gerente.credito.index'), icon: 'M12 2C6.477 2 2 6.477 2 12v8c0 5.523 4.477 10 10 10s10-4.477 10-10-4.477-10-10-10zM12 8v4m0 4h.01' },
        ...
        { name: 'Fidelización', href: route('gerente.fidelizacion.index'), icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' }
    ] : [
        ...
        { name: 'Cobros', href: route('cajera.cobranza.index'), icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
