            ...
            <form onSubmit={submit}>
                ...
                <div className="flex items-center justify-between mt-5">
                    <label className="flex items-center cursor-pointer">
                        ...
                        />
                        <span className="ms-2 text-sm text-gray-600 select-none">Recuérdame</span>
                    </label>

                    {canResetPassword && (
                        <Link
                            href={route('password.request')}
                            className="text-sm font-medium text-green-600 hover:text-green-500 focus:outline-none hover:underline transition duration-150 ease-in-out"
                        >
                ...
                <div className="mt-6">
                    <PrimaryButton
                        className="w-full flex justify-center py-3 text-base font-semibold tracking-wide bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 shadow-md hover:shadow-lg disabled:opacity-75 disabled:cursor-not-allowed transition-all duration-200 border-transparent rounded-lg text-white"
