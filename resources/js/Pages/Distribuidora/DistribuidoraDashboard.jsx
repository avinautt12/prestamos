                        ...
                        {quickActions.map((action) => (
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className={`mt-1 text-xs leading-5 ${action.tone === 'primary' ? 'text-white/75' : 'text-gray-500'}`}>{action.description}</p>
                                </div>
                                <span className={`mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full ${action.tone === 'primary' ? 'bg-white/15 text-white' : 'bg-gray-100 text-gray-500'}`}>
