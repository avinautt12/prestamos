            ...
            <div className="max-w-6xl mx-auto space-y-4">
                <div className="fin-card">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 bg-gray-50 p-1.5 rounded-lg border border-gray-200">
                            ...
                            <select 
                                ...
                                className="fin-input w-full sm:w-[260px] bg-white cursor-pointer !py-1 !pr-8 !text-sm text-ellipsis"
                            >
                                {estados.map((item) => (
