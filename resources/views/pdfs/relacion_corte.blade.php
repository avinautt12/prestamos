...
<body>
    ...
    <div>
        <div class="info-box">
            ...
            <p><span class="font-bold">Nombre:</span> {{ $distribuidora->persona->primer_nombre ?? 'N/A' }}
        ...
        <div class="info-box" style="margin-left: 3%;">
            ...
            <p><span class="font-bold">Fecha de Generación:</span>
                {{ \Carbon\Carbon::parse($relacion->generada_en)->format('d/m/Y') }}</p>
            <p><span class="font-bold">Fecha Límite de Pago:</span>
                {{ \Carbon\Carbon::parse($relacion->fecha_limite_pago)->format('d/m/Y') }}</p>
    ...
    <div class="summary-box">
        ...
        <table style="border: none; margin-top: 0;">
            <tr>
                <td style="border: none; width: 33%;"><strong>Total a
                        Pagar:</strong><br>${{ number_format($relacion->total_a_pagar, 2) }}</td>
            </tr>
        </table>
    </div>
    ...
    <div style="margin-top: 40px; padding-top: 10px; border-top: 1px solid #ddd;">
        ...
        <p style="font-size: 13px;">Puedes realizar tu pago en los banco(s) que se muestran a continuación usando la
            <strong>Referencia de Pago: {{ $relacion->referencia_pago }}</strong>.
        </p>
        ...
        <table style="margin-top: 15px;">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align: center;">Consulta con la sucursal las cuentas bancarias para
                            depositar.</td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="footer">
        <p>Este documento es una referencia de pago oficial. Si tiene alguna duda o aclaración, contacte a su sucursal.
        </p>
        <p>Página 1 de 1</p>
    </div>
</body>
